...
from data_utils import create_datasets, load_data, select_random_subjects
from model import AutoEncoder
from ppm_tools import ppm_to_point_index
from trainning import train
from utils import compare_plot, filter_low_power, normalize, plot_freq, save_checkpoint
...
print('Random Test Subjects:', test_sub_list)
...
z_train = torch.tensor(z_train_filtered).to(device)
...
# save checkpoint
ex_subs = '_ex' + '-'.join(map(str, test_sub_list)) # excluded subjects
